package com.nayibit.feature_deckscreen.presentation.composables
...
fun TutorialBase(
    ...
    Box(modifier = Modifier.fillMaxSize().testTag("tutorial_base")) {
        content()
        ...
        if (isTutorialEnabled && listComponents.isNotEmpty() && currentIndex < listComponents.size) {
            ...
            Canvas(
                ...
                val pathMeasure = PathMeasure(composePath.asAndroidPath(), true)
